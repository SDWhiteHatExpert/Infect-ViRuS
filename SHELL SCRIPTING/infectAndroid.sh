# A tool by virus from https://github.com/SDWhiteHatExpert
# Be a unique person not copy cat
# Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the License. You may obtain a copy of
# Headers of the sever
# Headers of
# Colours
#-----------------
# remeber to install latest python3
red="\e[91m"
rset="\e[0m"
grn="\e[92m"
ylo="\e[93m"
...
'
echo " " 
echo -e "$red                       ▶Coded by$grn TECHY SDX$red◀$rset"
echo -e "$red                      ⫸$ylo  TECHY SDX$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [Infect the device with fun]$rset"
echo " "
echo " "
}
baner1(){
...
then
am start -a android.intent.action.VIEW -d https://github.com/SDWhiteHatExpert > /dev/null 2>&1
banner
menu
elif [ $optnz = "6" ];
then
...
loss you do to other's by this script. use it by consent of your victims."
echo
echo -ne "\e[92m#Type exit : "
read exitz
if [ $exitz = "exit" ];
...
echo -e '\e[91m
         ...
         ────▌──▐────
'
echo -e "\e[93m                  CALL ME \e[92mTECHY SDX" | pv -qL 10
echo -e "\e[93m             IAM FROM \e[92mTECHY SDX" | pv -qL 10
...
echo -e "\e[93m        MY WEBSITE:\e[92mwww.youtube.com/TECHYSDX\e[0m" | pv -qL 10
...
while git clone  https://github.com/SDWhiteHatExpert 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
...
echo
echo
printf "\e[96m           UPDATE SUCCESSFULL (LATEST V.2 VERSION)..!\e[0m"
sleep 2.0
cd $HOME
cd infect
bash infect.sh
...
if [ "$p" = "y" ];
then
am start -a android.intent.action.VIEW -d https://github.com/SDWhiteHatExpert 2>/dev/null
clear
baner1
menu
elif [ "$p" = "t" ];
